...
app.layout = html.Div([
    html.H4('Интерактивная карта навыков (можно выбрать разные резмы в выпающих списках и кликать категории в легенде)'),
    dcc.Dropdown(['50 новыков каждой вакансии', '100 новыков каждой вакансии', '200 новыков каждой вакансии'], 
                 '100 новыков каждой вакансии', id='top-dropdown'),
